...
#include "snaphu.h"
#include "snaphu_win_compat.h"

/* static (local) function prototypes */
static long ThickenCosts(incrcostT **incrcosts, long nrow, long ncol);
static nodeT *RegionsNeighborNode(nodeT *node1, long *arcnumptr, nodeT **nodes,
                                  long *arcrowptr, long *arccolptr, long nrow,
                                  long ncol);
static int ClearBuckets(bucketT *bkts);
static int MergeRegions(nodeT **nodes, nodeT *source, long *regionsizes,
                        long closestregion, long nrow, long ncol);
static int RenumberRegion(nodeT **nodes, nodeT *source, long newnum, long nrow,
                          long ncol);
static int ReadNextRegion(long tilerow, long tilecol, long nlines, long linelen,
                          outfileT *outfiles, paramT *params,
                          short ***nextregionsptr, float ***nextunwphaseptr,
                          void ***nextcostsptr, long *nextnrowptr,
                          long *nextncolptr);
static int SetTileReadParams(tileparamT *tileparams, long nexttilenlines,
                             long nexttilelinelen, long tilerow, long tilecol,
                             long nlines, long linelen, paramT *params);
static int ReadEdgesAboveAndBelow(long tilerow, long tilecol, long nlines,
                                  long linelen, paramT *params,
                                  outfileT *outfiles, short *regionsabove,
                                  short *regionsbelow, float *unwphaseabove,
                                  float *unwphasebelow, void *costsabove,
                                  void *costsbelow);
static int TraceRegions(short **regions, short **nextregions,
                        short **lastregions, short *regionsabove,
                        short *regionsbelow, float **unwphase,
                        float **nextunwphase, float **lastunwphase,
                        float *unwphaseabove, float *unwphasebelow,
                        void **costs, void **nextcosts, void **lastcosts,
                        void *costsabove, void *costsbelow, long prevnrow,
                        long prevncol, long tilerow, long tilecol, long nrow,
                        long ncol, nodeT **scndrynodes, nodesuppT **nodesupp,
                        scndryarcT **scndryarcs, long ***scndrycosts,
                        int *nscndrynodes, int *nscndryarcs, long *totarclens,
                        short **bulkoffsets, paramT *params);
static long FindNumPathsOut(nodeT *from, paramT *params, long tilerow,
                            long tilecol, long nnrow, long nncol,
                            short **regions, short **nextregions,
                            short **lastregions, short *regionsabove,
                            short *regionsbelow, long prevncol);
static int RegionTraceCheckNeighbors(
    nodeT *from, nodeT **nextnodeptr, nodeT **primarynodes, short **regions,
    short **nextregions, short **lastregions, short *regionsabove,
    short *regionsbelow, long tilerow, long tilecol, long nnrow, long nncol,
    nodeT **scndrynodes, nodesuppT **nodesupp, scndryarcT **scndryarcs,
    long *nnewnodesptr, long *nnewarcsptr, long flowmax, long nrow, long ncol,
    long prevnrow, long prevncol, paramT *params, void **costs,
    void **rightedgecosts, void **loweredgecosts, void **leftedgecosts,
    void **upperedgecosts, short **flows, short **rightedgeflows,
    short **loweredgeflows, short **leftedgeflows, short **upperedgeflows,
    long ***scndrycosts, nodeT ***updatednontilenodesptr,
    long *nupdatednontilenodesptr, long *updatednontilenodesizeptr,
    short **inontilenodeoutarcptr, long *totarclenptr);
static int SetUpperEdge(long ncol, long tilerow, long tilecol, void **voidcosts,
                        void *voidcostsabove, float **unwphase,
                        float *unwphaseabove, void **voidupperedgecosts,
                        short **upperedgeflows, paramT *params,
                        short **bulkoffsets);
static int SetLowerEdge(long nrow, long ncol, long tilerow, long tilecol,
...
static int SetLeftEdge(long nrow, long prevncol, long tilerow, long tilecol,
                       void **voidcosts, void **voidlastcosts, float **unwphase,
                       float **lastunwphase, void **voidleftedgecosts,
                       short **leftedgeflows, paramT *params,
                       short **bulkoffsets);
static int SetRightEdge(long nrow, long ncol, long tilerow, long tilecol,
                        void **voidcosts, void **voidnextcosts,
                        float **unwphase, float **nextunwphase,
                        void **voidrightedgecosts, short **rightedgeflows,
                        paramT *params, short **bulkoffsets);
static short AvgSigSq(short sigsq1, short sigsq2);
static int TraceSecondaryArc(
    nodeT *primaryhead, nodeT **scndrynodes, nodesuppT **nodesupp,
    scndryarcT **scndryarcs, long ***scndrycosts, long *nnewnodesptr,
    long *nnewarcsptr, long tilerow, long tilecol, long flowmax, long nrow,
    long ncol, long prevnrow, long prevncol, paramT *params, void **tilecosts,
    void **rightedgecosts, void **loweredgecosts, void **leftedgecosts,
    void **upperedgecosts, short **tileflows, short **rightedgeflows,
    short **loweredgeflows, short **leftedgeflows, short **upperedgeflows,
    nodeT ***updatednontilenodesptr, long *nupdatednontilenodesptr,
    long *updatednontilenodesizeptr, short **inontilenodeoutarcptr,
    long *totarclenptr);
static nodeT *FindScndryNode(nodeT **scndrynodes, nodesuppT **nodesupp,
                             long tilenum, long primaryrow, long primarycol);
static int IntegrateSecondaryFlows(long linelen, long nlines,
                                   nodeT **scndrynodes, nodesuppT **nodesupp,
                                   scndryarcT **scndryarcs, int *nscndryarcs,
                                   short **scndryflows, short **bulkoffsets,
                                   outfileT *outfiles, paramT *params);
static int ParseSecondaryFlows(long tilenum, int *nscndryarcs,
                               short **tileflows, short **regions,
                               short **scndryflows, nodesuppT **nodesupp,
                               scndryarcT **scndryarcs, long nrow, long ncol,
                               long ntilerow, long ntilecol, paramT *params);
static int AssembleTileConnComps(long linelen, long nlines, outfileT *outfiles,
                                 paramT *params);
static int ConnCompSizeNPixCompare(const void *ptr1, const void *ptr2);

/* function: SetupTile()
 * ---------------------
 * Sets up tile parameters and output file names for the current tile.
 */
int SetupTile(long nlines, long linelen, paramT *params, tileparamT *tileparams,
              outfileT *outfiles, outfileT *tileoutfiles, long tilerow,
              long tilecol) {
  ...
  sprintf(tempstring, "%s/%s%s_%ld_%ld.%ld", tiledir, TMPTILEROOT, basename,
          tilerow, tilecol, tileparams->ncol);
  ...
  if (strlen(outfiles->costoutfile)) {
    ...
    sprintf(tempstring, "%s/%s%s%ld_%ld.%ld", tiledir, TMPTILEROOT,
            TMPTILECOSTSUFFIX, tilerow, tilecol, tileparams->ncol);
    StrNCopy(tileoutfiles->costoutfile, tempstring, MAXSTRLEN);
  }
...
signed char **SetUpDoTileMask(infileT *infiles, long ntilerow, long ntilecol) {
  ...
  /* get memory */
  dotilemask = (signed char **)Get2DMem(
      ntilerow, ntilecol, sizeof(signed char *), sizeof(signed char));
  ...
  if (strlen(infiles->dotilemaskfile)) {
    ...
    Read2DArray((void ***)&dotilemask, infiles->dotilemaskfile, ntilecol,
                ntilerow, readparams, sizeof(signed char *),
                sizeof(signed char));
...
int GrowRegions(void **costs, short **flows, long nrow, long ncol,
  ...
  if (params->p >= 0) {
    ...
    Read2DRowColFile((void ***)&growregionscosts, outfiles->costoutfile, ncol,
  ...
  for (arcrow = 0; arcrow < 2 * nrow - 1; arcrow++) {
    ...
    for (arccol = 0; arccol < maxcol; arccol++) {
      ...
      ReCalcCost(growregionscosts, incrcosts, flows[arcrow][arccol], arcrow,
                 arccol, 1, nrow, params);

      /* store lesser of incremental costs in first field */
      if (incrcosts[arcrow][arccol].negcost <
    ...
    for (col = 0; col < ncol; col++) {
      ...
      if (nodes[row][col].incost < 0) {
        ...
        if (++regioncounter >= regionsizeslen) {
          regionsizeslen += INITARRSIZE;
          regionsizes =
              (long *)ReAlloc(regionsizes, regionsizeslen * sizeof(long));
        }
        ...
        while (TRUE) {
          ...
          if (from == NULL) {
            if (*thisregionsize >= minsize) {
              ...
              MergeRegions(nodes, source, regionsizes, closestregion, nrow,
                           ncol);
              regioncounter--;
              break;
            }
          ...
          arcnum = 0;
          while ((to = RegionsNeighborNode(from, &arcnum, nodes, &arcrow,
                                           &arccol, nrow, ncol)) != NULL) {
...
int GrowConnCompsMask(void **costs, short **flows, long nrow, long ncol,
  ...
  for (arcrow = 0; arcrow < 2 * nrow - 1; arcrow++) {
    ...
    for (arccol = 0; arccol < maxcol; arccol++) {
      ...
      /* compute incremental costs of unit flows in either direction */
      ReCalcCost(costs, incrcosts, flows[arcrow][arccol], arcrow, arccol, 1,
                 nrow, params);
  ...
  fprintf(sp1,
          "Writing connected components to file %s"
...
static int MergeRegions(nodeT **nodes, nodeT *source, long *regionsizes,
  ...
  while (nextnodelistnext) {
    ...
    arcnum = 0;
    while ((to = RegionsNeighborNode(from, &arcnum, nodes, &arcrow, &arccol,
                                     nrow, ncol)) != NULL) {
 ...
 * -------------------------
 */
int AssembleTiles(outfileT *outfiles, paramT *params, long nlines,
                  long linelen) {
  ...
  */
  ...
  bulkoffsets =
      (short **)Get2DMem(ntilerow, ntilecol, sizeof(short *), sizeof(short));
  costs = (void **)Get2DRowColMem(ni + 2, nj + 2, sizeof(void *), costtypesize);
  nextcosts =
      (void **)Get2DRowColMem(ni + 2, nj + 2, sizeof(void *), costtypesize);
  lastcosts =
      (void **)Get2DRowColMem(ni + 2, nj + 2, sizeof(void *), costtypesize);
    ...
    for (tilecol = 0; tilecol < ntilecol; tilecol++) {
      ...
      if (tilecol == 0) {
        ReadNextRegion(tilerow, 0, nlines, linelen, outfiles, params,
                       &nextregions, &nextunwphase, &nextcosts, &nextnrow,
                       &nextncol);
        prevnrow = nrow;
        nrow = nextnrow;
      }
      ...
      ReadEdgesAboveAndBelow(
          tilerow, tilecol, nlines, linelen, params, outfiles, regionsabove,
          regionsbelow, unwphaseabove, unwphasebelow, costsabove, costsbelow);

      /* trace region edges to form nodes and arcs */
      TraceRegions(regions, nextregions, lastregions, regionsabove,
                   regionsbelow, unwphase, nextunwphase, lastunwphase,
                   unwphaseabove, unwphasebelow, costs, nextcosts, lastcosts,
                   costsabove, costsbelow, prevnrow, prevncol, tilerow, tilecol,
                   nrow, ncol, scndrynodes, nodesupp, scndryarcs, scndrycosts,
                   nscndrynodes, nscndryarcs, totarclens, bulkoffsets, params);
    }
  }
  ...
  for (i = 0; i < ntiles; i++) {
    for (j = 0; j < nscndryarcs[i]; j++) {
      if (scndrycosts[i][j][2 * flowmax + 1] != ZEROCOSTARC) {
        ...
        scndrycosts[i][j][2 * flowmax + 1] =
            LRound(scndrycosts[i][j][2 * flowmax + 1] / avgarclen);
  ...
  for (i = 0; i < ntiles; i++) {
    ...
    iscandidate[i] =
        (signed char *)MAlloc(nscndryarcs[i] * sizeof(signed char));
  ...
  InitNetwork(scndryflows, &dummylong, &ncycle, &nflowdone, &dummylong, &nflow,
              ...
              NULL, NULL, NULL, NULL, ntiles, 0, &notfirstloop, &totalcost,
              params);
  ...
  while (TRUE) {
    ...
    SetupIncrFlowCosts((void **)scndrycosts, incrcosts, scndryflows, nflow,
                       ntiles, ntiles, nscndryarcs, params);

    /* set the tree root (equivalent to source of shortest path problem) */
    sourcetilenum =
        (long)ntilecol * floor(ntilerow / 2.0) + floor(ntilecol / 2.0);
    source = &scndrynodes[sourcetilenum][0];

    /* set up network variables for tree solver */
    SetupTreeSolveNetwork(scndrynodes, NULL, scndryapexes, iscandidate, ntiles,
                          nscndrynodes, ntiles, nscndryarcs, ntiles, 0);

    /* run the solver, and increment nflowdone if no cycles are found */
    n = TreeSolve(scndrynodes, nodesupp, NULL, source, &candidatelist,
                  &candidatebag, &candidatelistsize, &candidatebagsize, bkts,
                  scndryflows, (void **)scndrycosts, incrcosts, scndryapexes,
                  iscandidate, 0, nflow, NULL, NULL, NULL, ntiles, nscndrynodes,
                  ntiles, nscndryarcs, ntiles, 0, NULL, nnodes, params);

    /* evaluate and save the total cost (skip if first loop through nflow) */
    if (notfirstloop) {
      oldtotalcost = totalcost;
      totalcost = EvaluateTotalCost((void **)scndrycosts, scndryflows, ntiles,
                                    0, nscndryarcs, params);
  ...
  IntegrateSecondaryFlows(linelen, nlines, scndrynodes, nodesupp, scndryarcs,
                          nscndryarcs, scndryflows, bulkoffsets, outfiles,
                          params);
  ...
  if (params->rmtmptile) {
    ...
    for (tilerow = 0; tilerow < ntilerow; tilerow++) {
      for (tilecol = 0; tilecol < ntilecol; tilecol++) {
        sprintf(filename, "%s/%s%ld_%ld", params->tiledir, LOGFILEROOT, tilerow,
                tilecol);
        unlink(filename);
      }
    }
  ...
  if (params->rowovrlp < ni || params->colovrlp < nj) {
    fflush(NULL);
    fprintf(sp1, "SUGGESTION: Try increasing tile overlap and/or size"
...
static int ReadNextRegion(long tilerow, long tilecol, long nlines, long linelen,
  ...
  SetTileReadParams(nexttileparams, nexttilenlines, nexttilelinelen, tilerow,
                    tilecol, nlines, linelen, params);

  /* read region data */
  ParseFilename(outfiles->outfile, path, basename);
  sprintf(tempstring, "%s/%s%s_%ld_%ld.%ld%s", params->tiledir, TMPTILEROOT,
          basename, tilerow, tilecol, nexttilelinelen, REGIONSUFFIX);
  StrNCopy(nextfile, tempstring, MAXSTRLEN);
  Read2DArray((void ***)nextregionsptr, nextfile, nexttilelinelen,
              nexttilenlines, nexttileparams, sizeof(short *), sizeof(short));
  ...
  FlipPhaseArraySign(*nextunwphaseptr, params, nexttileparams->nrow,
                     nexttileparams->ncol);
...
static int SetTileReadParams(tileparamT *tileparams, long nexttilenlines,
  ...
  if (tilerow != params->ntilerow - 1) {
    tileparams->nrow =
        nexttilenlines - floor(rowovrlp / 2.0) - tileparams->firstrow;
  } else {
  ...
  if (tilecol != params->ntilecol - 1) {
    tileparams->ncol =
        nexttilelinelen - floor(colovrlp / 2.0) - tileparams->firstcol;
  } else {
...
static int ReadEdgesAboveAndBelow(long tilerow, long tilecol, long nlines,
  ...
  if (tilecol != params->ntilecol - 1) {
    readtilelinelen = nj;
    tileparams->ncol =
        readtilelinelen - floor(colovrlp / 2.0) - tileparams->firstcol;
  } else {
  ...
  if (tilerow != 0) {
    ...
    ParseFilename(outfiles->outfile, path, basename);
    sprintf(tempstring, "%s/%s%s_%ld_%ld.%ld%s", params->tiledir, TMPTILEROOT,
            basename, tilerow - 1, tilecol, readtilelinelen, REGIONSUFFIX);
    StrNCopy(readregionfile, tempstring, MAXSTRLEN);
    Read2DArray((void ***)&regionsaboveptr, readregionfile, readtilelinelen,
                readtilenlines, tileparams, sizeof(short *), sizeof(short));
    ...
    if (TMPTILEOUTFORMAT == ALT_LINE_DATA) {
      ...
      Read2DArray((void ***)&unwphaseaboveptr, outfilesabove->outfile,
                  readtilelinelen, readtilenlines, tileparams, sizeof(float *),
                  sizeof(float));
    }

    /* flip sign of wrapped phase if flip flag is set */
    FlipPhaseArraySign(unwphaseaboveptr, params, tileparams->nrow,
                       tileparams->ncol);
  ...
  if (tilerow != ntilerow - 1) {
    ...
    sprintf(tempstring, "%s/%s%s_%ld_%ld.%ld%s", params->tiledir, TMPTILEROOT,
            basename, tilerow + 1, tilecol, readtilelinelen, REGIONSUFFIX);
    StrNCopy(readregionfile, tempstring, MAXSTRLEN);
    Read2DArray((void ***)&regionsbelowptr, readregionfile, readtilelinelen,
                readtilenlines, tileparams, sizeof(short *), sizeof(short));
    ...
    FlipPhaseArraySign(unwphasebelowptr, params, tileparams->nrow,
                       tileparams->ncol);
...
static int TraceRegions(short **regions, short **nextregions,
  ...
  nncol = ncol + 1;
  primarynodes =
      (nodeT **)Get2DMem(nnrow, nncol, sizeof(nodeT *), sizeof(nodeT));
  ...
  /* get memory */
  updatednontilenodes =
      (nodeT **)MAlloc(updatednontilenodesize * sizeof(nodeT *));
  inontilenodeoutarc = (short *)MAlloc(updatednontilenodesize * sizeof(short));
  flows = (short **)Get2DRowColMem(nrow + 1, ncol + 1, sizeof(short *),
                                   sizeof(short));
  ...
  SetUpperEdge(ncol, tilerow, tilecol, costs, costsabove, unwphase,
               unwphaseabove, upperedgecosts, upperedgeflows, params,
               bulkoffsets);
  SetLowerEdge(nrow, ncol, tilerow, tilecol, costs, costsbelow, unwphase,
               unwphasebelow, loweredgecosts, loweredgeflows, params,
               bulkoffsets);
  ...
  SetRightEdge(nrow, ncol, tilerow, tilecol, costs, nextcosts, unwphase,
               nextunwphase, rightedgecosts, rightedgeflows, params,
               bulkoffsets);
  ...
  while (nextnode != NULL) {
    ...
    npathsout = FindNumPathsOut(from, params, tilerow, tilecol, nnrow, nncol,
                                regions, nextregions, lastregions, regionsabove,
    ...
    if (npathsout > 2) {
      ...
      if ((from->row != 0 || tilerow == 0) &&
          (from->col != 0 || tilecol == 0)) {
        ...
        scndrynodes[tilenum] =
            (nodeT *)ReAlloc(scndrynodes[tilenum], nnewnodes * sizeof(nodeT));
    ...
    RegionTraceCheckNeighbors(
        from, &nextnode, primarynodes, regions, nextregions, lastregions,
        regionsabove, regionsbelow, tilerow, tilecol, nnrow, nncol, scndrynodes,
        nodesupp, scndryarcs, &nnewnodes, &nnewarcs, flowmax, nrow, ncol,
        prevnrow, prevncol, params, costs, rightedgecosts, loweredgecosts,
        leftedgecosts, upperedgecosts, flows, rightedgeflows, loweredgeflows,
        leftedgeflows, upperedgeflows, scndrycosts, &updatednontilenodes,
        &nupdatednontilenodes, &updatednontilenodesize, &inontilenodeoutarc,
        &totarclen);
  }
  ...
  for (i = 0; i < nnewarcs; i++) {
    ...
    scndryarcs[tilenum][i].to = &scndrynodes[tempnode->level][tempnode->incost];
...
static long FindNumPathsOut(nodeT *from, paramT *params, long tilerow,
  ...
  if (fromcol != 0) {
    ...
    if (fromrow == 0 || fromrow == nnrow - 1 ||
        (tilecol != 0 && (lastregions[fromrow][prevncol - 1] !=
  ...
  if (fromrow != 0) {
    ...
    if (fromcol == 0 || fromcol == nncol - 1 ||
        (tilerow != 0 && regionsabove[fromcol - 1] != regionsabove[fromcol])) {
      npathsout++;
    }
  }
    ...
    if (fromrow == 0 || fromrow == nnrow - 1 ||
      ...
      if (to != from->pred) {
        ...
        if (to->group == NOTINBUCKET) {
          ...
          TraceSecondaryArc(
              to, scndrynodes, nodesupp, scndryarcs, scndrycosts, nnewnodesptr,
              nnewarcsptr, tilerow, tilecol, flowmax, nrow, ncol, prevnrow,
              prevncol, params, costs, rightedgecosts, loweredgecosts,
              leftedgecosts, upperedgecosts, flows, rightedgeflows,
              loweredgeflows, leftedgeflows, upperedgeflows,
              updatednontilenodesptr, nupdatednontilenodesptr,
              updatednontilenodesizeptr, inontilenodeoutarcptr, totarclenptr);
        }
      }
    }
  }
...
static int SetUpperEdge(long ncol, long tilerow, long tilecol, void **voidcosts,
  ...
  if (tilerow != 0) {
    ...
    reloffset =
        bulkoffsets[tilerow - 1][tilecol] - bulkoffsets[tilerow][tilecol];
    ...
    for (col = 0; col < ncol; col++) {
      ...
      if (CalcCost == CalcCostTopo || CalcCost == CalcCostDefo) {
        ...
        upperedgecosts[0][col].sigsq =
            AvgSigSq(costs[0][col].sigsq, costsabove[col].sigsq);
...
static int SetLowerEdge(long nrow, long ncol, long tilerow, long tilecol,
  ...
  if (tilerow != params->ntilerow - 1) {
    ...
    for (col = 0; col < ncol; col++) {
      ...
      if (CalcCost == CalcCostTopo || CalcCost == CalcCostDefo) {
        ...
        loweredgecosts[0][col].sigsq =
            AvgSigSq(costs[nrow - 2][col].sigsq, costsbelow[col].sigsq);
    ...
    bulkoffsets[tilerow + 1][tilecol] =
        bulkoffsets[tilerow][tilecol] - reloffset;
...
static int SetLeftEdge(long nrow, long prevncol, long tilerow, long tilecol,
  ...
  if (tilecol != 0) {
    ...
    nshortcycle = params->nshortcycle;
    reloffset =
        bulkoffsets[tilerow][tilecol] - bulkoffsets[tilerow][tilecol - 1];

    /* loop over all arcs on the boundary */
    for (row = 0; row < nrow; row++) {
      dphi = (unwphase[row][0] - lastunwphase[row][prevncol - 1]) / TWOPI;
      ...
      if (CalcCost == CalcCostTopo || CalcCost == CalcCostDefo) {
        ...
        if (costs[row + nrow - 1][0].dzmax >
            lastcosts[row + nrow - 1][prevncol - 2].dzmax) {
          leftedgecosts[row][0].dzmax = costs[row + nrow - 1][0].dzmax;
        } else {
          leftedgecosts[row][0].dzmax =
              lastcosts[row + nrow - 1][prevncol - 2].dzmax;
        }
        ...
        ((short **)voidleftedgecosts)[row][0] =
            (((short **)voidcosts)[row + nrow - 1][0] +
             ((short **)voidlastcosts)[row + nrow - 1][prevncol - 2]) /
            2;
      } else if (CalcCost == CalcCostL0BiDir || CalcCost == CalcCostL1BiDir ||
                 CalcCost == CalcCostL2BiDir || CalcCost == CalcCostLPBiDir) {
        ((bidircostT **)voidleftedgecosts)[row][0].posweight =
            (((bidircostT **)voidcosts)[row + nrow - 1][0].posweight +
             ((bidircostT **)voidlastcosts)[row + nrow - 1][prevncol - 2]
                 .posweight) /
            2;
...
static int SetRightEdge(long nrow, long ncol, long tilerow, long tilecol,
  ...
  if (tilecol != params->ntilecol - 1) {
    ...
    /* loop over all arcs on the boundary */
    for (row = 0; row < nrow; row++) {
      dphi = (nextunwphase[row][0] - unwphase[row][ncol - 1]) / TWOPI;
      tempflow = (short)LRound(dphi);
      ...
      if (CalcCost == CalcCostTopo || CalcCost == CalcCostDefo) {
        ...
        if (costs[row + nrow - 1][ncol - 2].dzmax >
            nextcosts[row + nrow - 1][0].dzmax) {
          rightedgecosts[row][0].dzmax = costs[row + nrow - 1][ncol - 2].dzmax;
        } else {
          rightedgecosts[row][0].dzmax = nextcosts[row + nrow - 1][0].dzmax;
        }
        if (costs[row + nrow - 1][ncol - 2].laycost >
            nextcosts[row + nrow - 1][0].laycost) {
          rightedgecosts[row][0].laycost =
              costs[row + nrow - 1][ncol - 2].laycost;
        } else {
    ...
    if (tilerow == 0) {
      ...
      reloffset =
          bulkoffsets[tilerow][tilecol + 1] - bulkoffsets[tilerow][tilecol];
    }
...
static int TraceSecondaryArc(
  ...
  while (TRUE) {
    ...
    while (TRUE) {
      ...
      if (!zerocost) {
        ...
        nomcost = EvalCost(costs, flows, primaryarcrow, primaryarccol,
                           calccostnrow, params);
        ...
        if (CalcCost == CalcCostTopo || CalcCost == CalcCostDefo) {
          ...
          if (minweight < 1) {
            ...
            sigsq = 1.0 / (double)minweight;
                   ...
                   CalcCost == CalcCostL2BiDir || CalcCost == CalcCostLPBiDir) {
          minweight = LMin(
              ((bidircostT **)costs)[primaryarcrow][primaryarccol].posweight,
              ((bidircostT **)costs)[primaryarcrow][primaryarccol].negweight);
          if (minweight < 1) {
            sigsq = LARGESHORT;
          } else {
            sigsq = 1.0 / (double)minweight;
  ...
  if (primarytail->row == 0 && tilerow != 0) {
    scndrytail = FindScndryNode(scndrynodes, nodesupp,
                                (tilerow - 1) * ntilecol + tilecol, prevnrow,
                                primarytail->col);
  ...
  for (i = 0; i < nodesupp[row][col].noutarcs; i++) {
    ...
    if ((nodesupp[row][col].outarcs[i] == NULL &&
      ...
      if (primarydummy->group != ONTREE) {
        ...
        TraceSecondaryArc(
            primarydummy, scndrynodes, nodesupp, scndryarcs, scndrycosts,
            nnewnodesptr, nnewarcsptr, tilerow, tilecol, flowmax, nrow, ncol,
            prevnrow, prevncol, params, tilecosts, rightedgecosts,
            loweredgecosts, leftedgecosts, upperedgecosts, tileflows,
            rightedgeflows, loweredgeflows, leftedgeflows, upperedgeflows,
            updatednontilenodesptr, nupdatednontilenodesptr,
            updatednontilenodesizeptr, inontilenodeoutarcptr, totarclenptr);
        TraceSecondaryArc(
            primaryhead, scndrynodes, nodesupp, scndryarcs, scndrycosts,
            nnewnodesptr, nnewarcsptr, tilerow, tilecol, flowmax, nrow, ncol,
            prevnrow, prevncol, params, tilecosts, rightedgecosts,
            loweredgecosts, leftedgecosts, upperedgecosts, tileflows,
            rightedgeflows, loweredgeflows, leftedgeflows, upperedgeflows,
  ...
  scndryarcs[tilenum] =
      (scndryarcT *)ReAlloc(scndryarcs[tilenum], nnewarcs * sizeof(scndryarcT));
  newarc = &scndryarcs[tilenum][nnewarcs - 1];
  newarc->arcrow = tilenum;
  newarc->arccol = nnewarcs - 1;
  scndrycosts[tilenum] =
      (long **)ReAlloc(scndrycosts[tilenum], nnewarcs * sizeof(long *));
  ...
  supptail->noutarcs++;
  supptail->neighbornodes = (nodeT **)ReAlloc(
      supptail->neighbornodes, supptail->noutarcs * sizeof(nodeT *));
  supptail->neighbornodes[supptail->noutarcs - 1] = primaryhead;
  primarytail->level = scndrytail->row;
  primarytail->incost = scndrytail->col;
  supptail->outarcs = (scndryarcT **)ReAlloc(
      supptail->outarcs, supptail->noutarcs * sizeof(scndryarcT *));
  supptail->outarcs[supptail->noutarcs - 1] = NULL;
  supphead->noutarcs++;
  supphead->neighbornodes = (nodeT **)ReAlloc(
      supphead->neighbornodes, supphead->noutarcs * sizeof(nodeT *));
  ...
  supphead->outarcs = (scndryarcT **)ReAlloc(
      supphead->outarcs, supphead->noutarcs * sizeof(scndryarcT *));
  ...
  if (scndrytail->row != tilenum) {
    if (++(*nupdatednontilenodesptr) == (*updatednontilenodesizeptr)) {
      ...
      (*updatednontilenodesptr) =
          (nodeT **)ReAlloc((*updatednontilenodesptr),
                            (*updatednontilenodesizeptr) * sizeof(nodeT *));
      (*inontilenodeoutarcptr) =
          (short *)ReAlloc((*inontilenodeoutarcptr),
                           (*updatednontilenodesizeptr) * sizeof(short));
    }
    (*updatednontilenodesptr)[*nupdatednontilenodesptr - 1] = scndrytail;
    (*inontilenodeoutarcptr)[*nupdatednontilenodesptr - 1] =
        supptail->noutarcs - 1;
  }
...
static int IntegrateSecondaryFlows(long linelen, long nlines,
  ...
  regions = (short **)Get2DMem(ni, nj, sizeof(short *), sizeof(short));
  tileflows =
      (short **)Get2DRowColMem(ni + 2, nj + 2, sizeof(short *), sizeof(short));
  ...
  for (tilerow = 0; tilerow < ntilerow; tilerow++) {
    ...
    for (tilecol = 0; tilecol < ntilecol; tilecol++) {
      ...
      ParseFilename(outfiles->outfile, path, basename);
      sprintf(tempstring, "%s/%s%s_%ld_%ld.%ld%s", params->tiledir, TMPTILEROOT,
              basename, tilerow, tilecol, readtilelinelen, REGIONSUFFIX);
      ...
      if (tilecol != ntilecol - 1) {
        nextrowoffset =
            (LRound((unwphase[0][colstart + ncol - 1] -
                     tileunwphase[0][ncol - 1]) /
                    TWOPI) +
             tileflows[nnrow][nncol - 1] + bulkoffsets[tilerow][tilecol] -
             bulkoffsets[tilerow][tilecol + 1]);
      }
      ...
      if (tilecol == 0 && tilerow != ntilerow - 1) {
        nextcoloffset =
            (LRound((unwphase[nrow - 1][colstart] - tileunwphase[nrow - 1][0]) /
                    TWOPI) -
             tileflows[nnrow - 1][0] + bulkoffsets[tilerow][tilecol] -
             bulkoffsets[tilerow + 1][tilecol]);
      }
  ...
  for (arcnum = 0; arcnum < nscndryarcs[tilenum]; arcnum++) {
    ...
    if (nflow) {
      ...
      while (!(nextrow == primaryfromrow && nextcol == primaryfromcol)) {
        ...
        if (thiscol != 0) {
          if (thisrow == 0 || thisrow == nnrow - 1 ||
              regions[thisrow][thiscol - 1] !=
                  regions[thisrow - 1][thiscol - 1]) {
            if (!(thisrow == prevrow && thiscol - 1 == prevcol)) {
              tileflows[thisrow][thiscol - 1] += nflow;
              nextcol--;
            }
...
static int AssembleTileConnComps(long linelen, long nlines, outfileT *outfiles,
  ...
  tileconncomps = (unsigned int **)Get2DMem(ni, nj, sizeof(unsigned int *),
                                            sizeof(unsigned int));
  tilerowconncomps = (unsigned int **)Get2DMem(
      ni, linelen, sizeof(unsigned int *), sizeof(unsigned int));
      ...
      for (tilecol = 0; tilecol < ntilecol; tilecol++) {
        ...
        if (ipass == 0) {
            ...
            for (col = 0; col < ncol; col++) {
              ...
              if (iconncomp > 0) {
                ...
                while (iconncomp > ntileconncompmem) {
                  ...
                  tileconncompsizes = (conncompsizeT *)ReAlloc(
                      tileconncompsizes,
                      (ntileconncompmem * sizeof(conncompsizeT)));
          ...
          if (ntileconncomp > 0) {
            ...
            conncompsizes = (conncompsizeT *)ReAlloc(
                conncompsizes, (nconncompmem * sizeof(conncompsizeT)));
          }
          ...
          for (k = 0; k < ntileconncompmem; k++) {
            if (tileconncompsizes[k].npix > 0) {
              ...
              conncompsizes[nconncomp].icomptile =
                  tileconncompsizes[k].icomptile;
          ...
          for (row = 0; row < nrow; row++) {
            for (col = 0; col < ncol; col++) {
              iconncomp = tileconncomps[row][col];
              if (iconncomp > 0) {
                tilerowconncomps[row][colstart + col] =
                    tilemapping[iconncomp - 1];
              } else {
      ...
      if (ipass > 0) {
        for (row = 0; row < nrow; row++) {
          if (params->conncompouttype == CONNCOMPOUTTYPEUCHAR) {
            ...
            if (fwrite(tilerowconncomps[row], sizeof(unsigned int), linelen,
                       outfp) != linelen) {
              writeerror = TRUE;
              break;
            }
  ...
  /* close output file */
  fprintf(sp1,
          "Assembled connected components (%ld) output written to file %s\n",
